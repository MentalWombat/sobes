...
function Run({ disabled }: { disabled: boolean }) {
  return (
    <Link
      ...
      className="aria-disabled:text-subtle aria-disabled:border-subtle hover:border-accent2 hover:text-accent2 border-foreground cursor-pointer rounded-lg border px-4 py-2 text-center text-xl md:text-base"
